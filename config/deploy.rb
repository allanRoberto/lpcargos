...
set :application, "lpcargos" #FIXME
...
set :scm, :git
set :repository,  "git@github.com:allanRoberto/lpcargos.git" #FIXME
# set :scm, :subversion
...
set :local_path, "/Users/Allan/sites/lpcargos" #FIXME
...
set :local_domain, 'lpcargos.art.com.br' #FIXME
